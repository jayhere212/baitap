...
if (!empty($_POST)) {
	...
	if ($s_id != '') {
		//update
		$sql = "update student set fullname = '$s_fullname', email = '$s_email', address = '$s_address', sdt = '$s_sdt', ngaysinh = '$s_ngaysinh', gioitinh = '$s_gioitinh' where id = " .$s_id;
	} else {
		//insert
		$sql = "insert into student(fullname, email, address, sdt, ngaysinh, gioitinh) value ('$s_fullname', '$s_email', '$s_address', '$s_sdt', '$s_ngaysinh', '$s_gioitinh')";
	}
	...
	header('Location: quan-ly-hoc-sinh.php');
	die();
}
...
<body class="app sidebar-mini rtl">
    ...
    <header class="app-header">
        ...
        <ul class="app-nav">
            ...
            <!-- User Menu-->
            <li><a class="app-nav__item" href="./quan-ly-hoc-sinh.php"><i class='bx bx-log-out bx-rotate-180'></i> </a>
    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item">Danh sách hoc sinh</li>
