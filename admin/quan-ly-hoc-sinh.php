                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                                <a class="btn btn-add btn-sm" href="./form-add-hoc-sinh.php" title="Thêm">
                                    <i
                        ...
                        foreach ($studentList as $std) {
                            ...
                            <td>'.$std['ngaysinh'].'</td>
                            <td>'.$std['gioitinh'].'</td>
		                	<td><button class="btn btn-warning" onclick=\'window.open("form-add-hoc-sinh.php?id='.$std['id'].'","_self")\'>Sửa</button></td>
