                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                                <a class="btn btn-add btn-sm" href="./form-add-diem.php" title="Thêm"><i
                            ...
                            <tbody>
                                ...
                                foreach ($diemList as $std) {
                                    echo '<tr>
		                                ...
		                                <td>'.$std['diemtb'].'</td>
		                                <td>'.$std['xeploai'].'</td>
		                	            <td><button class="btn btn-warning" onclick=\'window.open("form-add-diem.php?id='.$std['id'].'","_self")\'>Sửa</button></td>
			                            <td><button class="btn btn-danger" onclick="deletediem('.$std['id'].')">Xoá</button></td>
		                                 </tr>';
                                }
                                ?>
                            </tbody>
